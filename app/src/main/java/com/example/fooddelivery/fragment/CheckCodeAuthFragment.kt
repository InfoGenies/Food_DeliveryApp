...
import com.example.fooddelivery.databinding.FragmentCheckCodeAuthBinding
import com.example.fooddelivery.utils.Constante.Companion.COUNT_DOWN_DELAY
import com.example.fooddelivery.utils.Constante.Companion.COUNT_DOWN_INTERVAL
...
class CheckCodeAuthFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater, R.layout.fragment_check_code_auth, container, false
        )
    ...
    private fun navigateToMainFragment() {
        val action =
            CheckCodeAuthFragmentDirections.actionCheckCodeAuthFragmentToHomeFragment()
    ...
    fun verifyPhoneNumber() {
        ...
        val smsCode = (binding.otpEditText1.text.toString() +
